    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"M. Fadli Alhafizh W");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE,18);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("M. Fadli Alhafizh W");
                mPerson.setAge(18);
                mPerson.setEmail("fadli.alhafizh5@gmailcom");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081214597885";
